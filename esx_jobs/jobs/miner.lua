			...
			Item = {
				{
					...
					time = 0.5,
					remove = 1,
					max = 55, -- if not present, probably an error at itemQtty >= item.max in esx_jobs_sv.lua
					price = 5,
					requires = 'copper',
			...
			Item = {
				{
					...
					time = 0.5,
					remove = 1,
					max = 45, -- if not present, probably an error at itemQtty >= item.max in esx_jobs_sv.lua
					price = 80,
					requires = 'platinum',
